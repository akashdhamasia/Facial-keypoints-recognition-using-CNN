...
FTRAIN = '/home/sprva/AAkash/TUM/Deeplearning-Project/aflw/data/data/training.csv' #aflw
...
net = NeuralNet(
    ...
    output_num_units=42, output_nonlinearity=None,

    update_learning_rate=theano.shared(float32(0.03)),
    update_momentum=theano.shared(float32(0.9)),

    regression=True,
    #batch_iterator_train=FlipBatchIterator(batch_size=128), #for aflw -> donot need data augmentation
    on_epoch_finished=[
